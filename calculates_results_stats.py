...
#                                                                             
# PROGRAMMER: Marcelle Candy
# DATE CREATED:   07/08/2023                               
# REVISED DATE:   07/12/2023
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        # Labels Match Exactly -  counts number of matches
        if results_dic[key][2] == 1:
            results_stats_dic["n_match"] += 1
            # Pet Image Label is a Dog AND Labels match - counts correct
            # dog breed
        ...
        # Pet Image Label is NOT a Dog - counts number of not-a-dog image
        else:
            results_stats_dic["n_notdogs_img"] += 1
            # Classifier classifies image as NOT a Dog (& pet image isn't a 
            # dog) - counts correct not-a-dog classifiaction
